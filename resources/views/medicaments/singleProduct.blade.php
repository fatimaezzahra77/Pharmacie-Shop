      ...
      <div class="row hygieneContainer" >
        ...
        <div class="col-md-9">
          <div class="row">
            <div class="col-md-12">
              <div class="row">
                <div class="col-md-5 card medicamentcard">
                  <img src="{{$medicamentsproduit->image}}" alt="imageLodingError" style="height: 400px; width: 400px">
                </div>
                <div class="col-md-6">
                  <h1 class="singleProductTitle">{{$medicamentsproduit->nom}}</h1>
                  ...
                  <p class="singleProductPrix">{{$medicamentsproduit->prix}}DH</p>
